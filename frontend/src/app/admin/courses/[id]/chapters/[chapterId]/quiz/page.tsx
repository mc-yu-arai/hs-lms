...
export default function AdminChapterQuizPage() {
  ...
  }, [isAuthorized, authFetch, courseId, chapterId, loadQuiz]);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await authFetch(`/v1/courses/${courseId}/chapters/${chapterId}/quiz`, {
        method: "POST",
        body: {
          title,
