  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="mx-auto max-w-3xl px-4 py-8">
        <div className="relative rounded-xl border-4 border-blue-700 bg-white p-12 text-center shadow-sm">
          <h2 className="mb-8 text-3xl font-bold text-gray-900">修了証</h2>
          ...
          <p className="mb-6 text-xl font-semibold text-gray-900">{courseTitle}</p>
          <p className="mb-6 text-sm text-gray-500">発行日: {issuedDate}</p>

          {qrDataUrl && (
            <div className="absolute bottom-6 right-6 text-center">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src={qrDataUrl} alt="検証用QRコード" className="h-20 w-20" />
